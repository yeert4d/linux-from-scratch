...
Out of scope:
  ...
  - Package managers
  - Usability or polish
  - Long-term maintenance as a distrobution.
...
Virtualization is used to ensure isolation, reproducibility and safe experimentation. 

---

## Structure
  - "docs/" - high-level explanations and rationale.
  - "notes/" - chronological build notes and observations.

This repository prioritises **clarity over completeness**.
...
The next items planned for this project are:
  ...
  - Capture errors and fixed as they occur
